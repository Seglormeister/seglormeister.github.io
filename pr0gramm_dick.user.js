...
function reloadcomments(id) {
	var endpoint = 'items.info';
	var url = 'http://pr0gramm.com/api/items/info?itemId=' + id;
	var errback = function(){ alert("fehler"); };
		...
		.done(function(responseText) {
			//p.View.Stream.Comments.prototype.loaded(responseText);
